"""Guard interface. The agent loop consults the guard in exactly three places:
before a tool call runs, on content coming back from a tool, and on the final
answer. Baseline = NoopGuard (everything passes). The defence stack is a
Guard built from a config."""
